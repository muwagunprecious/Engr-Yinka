...
const PIN_PROJECTS = [
  {
    ...
    description: "Afro-centered wellness companion app that won the Best Lovable Project award at the Lovable Women in AI Hackathon.",
    portrait: "/engr_yinka_1.jpeg",
    icon: <Brain className="w-4 h-4" />,
    stats: [{ label: "Year", value: "2025" }, { label: "Award", value: "1st Place" }],
    color: "#4ade80",
  },
  {
    id: 1,
    ...
    category: "AI Hardware • IoT",
    badge: "🎙 Multilingual AI",
    description: "AI-powered smart speaker featuring multilingual support for local African languages, bridging hardware and software.",
    portrait: "/engr_yinka_2.jpeg",
    icon: <Radio className="w-4 h-4" />,
    stats: [{ label: "Status", value: "MVP" }, { label: "Scope", value: "African" }],
    color: "#38bdf8",
  },
  {
    id: 2,
    ...
    badge: "☀️ ML Optimized",
    description: "A dual-axis solar tracking system featuring Machine Learning optimization and IoT monitoring using MG996R servo motors.",
    portrait: "/mg_0434.jpeg",
    icon: <Cpu className="w-4 h-4" />,
    stats: [{ label: "Servos", value: "MG996R" }, { label: "Control", value: "ML & IoT" }],
    color: "#f59e0b",
  },
  {
    id: 3,
    pinLabel: "A0",
    title: "SabiSales AI Agent",
    category: "Agentic AI • Sales",
    badge: "🤖 RAIN Hackathon",
    description: "An intelligent, agentic AI sales solution that secured 4th place in the Meta AI Developer Academy Hackathon.",
    portrait: "/mg_0440.jpeg",
    icon: <Settings className="w-4 h-4" />,
    stats: [{ label: "Rank", value: "4th Place" }, { label: "Platform", value: "Meta AI" }],
    color: "#c084fc",
  },
];
