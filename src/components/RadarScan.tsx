...
const radarBlips = [
  {
    ...
    sublabel: "Hardware-software integration, circuit prototyping, ESP32, and Raspberry Pi",
    angle: 18,
    radius: 0.55,
    tag: "CORE SKILL",
  },
  {
    ...
    sublabel: "PyTorch, LLMs (Llama 3/4), Agentic AI, RAG, NLP, and model deployment",
    angle: 65,
    radius: 0.40,
    tag: "EXPERTISE",
  },
  {
    id: 2,
    label: "Meta AI Developer",
    sublabel: "Certified Meta AI Academy Developer highly skilled in AI and automation",
    angle: 112,
    radius: 0.70,
    tag: "EXPERTISE",
  },
  {
    id: 3,
    label: "ADDEK Smart Speaker",
    sublabel: "🎙 Multilingual AI-powered smart speaker tailored for African languages (MVP in Dev)",
    angle: 158,
    radius: 0.48,
    tag: "PROJECT",
  },
  {
    ...
    sublabel: "☀️ Solar tracking system with ML optimization and IoT control via servo motors",
    angle: 205,
    radius: 0.63,
    tag: "PROJECT",
  },
  {
    id: 5,
    label: "APWEN Collegiate President",
    sublabel: "President of APWEN, OOU Chapter, leading initiatives empowering female engineers",
    angle: 248,
    radius: 0.38,
    tag: "LEADERSHIP",
  },
  {
    id: 6,
    label: "OOU Tech Community",
    sublabel: "Assistant Team Lead and former Embedded Systems & IoT Sub-Community Manager",
    angle: 295,
    radius: 0.72,
    tag: "LEADERSHIP",
  },
  {
    id: 7,
    label: "NION Academy COO",
    sublabel: "Chief Operation Officer & AI/Robotics Lead Facilitator training students",
    angle: 338,
    radius: 0.52,
    tag: "VENTURE",
  },
...
export default function RadarScan() {
  ...
  return (
    <section
      id="radar"
      className="relative w-full py-24 md:py-32 px-6 md:px-12 lg:px-24 overflow-hidden border-t border-white/5 bg-[#020405] z-20"
    >
      {/* Ambient glow */}
